...
namespace MultiFP
{
    ...
    {
        private readonly DeviceManipulator manipulator = new DeviceManipulator();
        ...
        private void BtnGetDeviceTime_Click(object sender, EventArgs e)
        {
            ...
            objZkeeper.GetDeviceTime(machineNumber, ref dwYear, ref dwMonth, ref dwDay, ref dwHour, ref dwMinute, ref dwSecond);
            ...
            {
                new DeviceTimeInfo() { DeviceTime = deviceTime }
            };
        ...
        private void BtnEnableDevice_Click(object sender, EventArgs e)
        {
            ...
            objZkeeper.EnableDevice(int.Parse(tbxMachineNumber.Text.Trim()), true);
        ...
        {
            // This is of no use since i implemented zkemKeeper the other way
            objZkeeper.DisableDeviceWithTimeOut(int.Parse(tbxMachineNumber.Text.Trim()), 3000);
        }
